...
constexpr char cfg_wifiSettingsChanged[] = "wifiSettingsChanged";
...
struct configSetting
{
    ...
    esp_err_t (*fn)(char *key, char *value);
};
...
public:
    ...
    bool getWifiSettingsChanged() { return std::get<bool>(get(cfg_wifiSettingsChanged)); };
...
public:
    ...
    int32_t read(const std::string &key, int32_t dflt = 0);
    bool write(const std::string &key, int32_t value);
