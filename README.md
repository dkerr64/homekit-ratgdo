...
> [!NOTE]
> As of Firmware v2.0.0 most of the source code for the ESP8266 and ESP32 versions have been merged. This allows for easier maintenance and equivalent features (where supported by the hardware).
